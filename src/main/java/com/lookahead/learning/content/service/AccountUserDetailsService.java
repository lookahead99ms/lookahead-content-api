...
public class AccountUserDetailsService implements UserDetailsService {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.lookahead.learning.content.security.LocalAuthorAccess localAuthor;
    private ProtectedContentPolicy publication;
    @org.springframework.beans.factory.annotation.Autowired(required=false)
    void publication(ProtectedContentPolicy value){publication=value;}
    ...
    public AccountView accountView(AccountPrincipal principal) {
        ...
        return new AccountView(principal.accountId(), principal.getUsername(),
                principal.displayName(), grants, publication==null?java.util.Set.of():publication.contentGrants(grants), localAuthor != null && localAuthor.allowed(principal));
    }
