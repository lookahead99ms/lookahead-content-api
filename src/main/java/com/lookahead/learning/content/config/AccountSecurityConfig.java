        ...
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/content/**", "/api/v1/auth/csrf", "/api/v1/status",
                        ...
                        .requestMatchers("/api/v1/executions/capabilities", "/api/v1/executions/jobs", "/api/v1/executions/jobs/*", "/api/v1/support", "/api/v1/auth/continue", "/api/v1/auth/me", "/api/v1/plans", "/api/v1/plans/**").authenticated()
                        .anyRequest().denyAll();
                })
