...
import com.lookahead.learning.content.controller.*;
...
import com.lookahead.learning.content.service.*;
...
class RegistrationSecurityIntegrationTest {
    ...
    @Import({AccountSecurityConfig.class, AuthController.class, RegistrationController.class, RegistrationService.class, AccountUserDetailsService.class, AccountErrorHandler.class, com.lookahead.learning.content.security.LocalAuthorAccess.class, LocalTestSeedGuard.class})
    static class App {
        ...
        @Bean AccountRepository accounts() {
            ...
            when(repo.findTopicGrants(any())).thenReturn(Set.of());
            return repo;
        }
    }
